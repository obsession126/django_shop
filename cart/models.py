...
class Cart(models.Model):
    ...
    def add_product(self,product,product_size,quantity=1):
        cart_item,created = CartItem.objects.get_or_create(cart=self,product=product,product_size=product_size,defaults={'quantity':quantity})
...
class CartItem(models.Model):
    ...
    def total_price(self):
        return Decimal(str(self.product_size) * self.quantity)
