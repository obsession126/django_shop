...
# from hardcore.models import Product
...
#         items = []
#         for item in self:
#             item.append({'product': item['product'],'quantity': item['quantity'],'size': item['size'],'price':Decimal(item['price']),'total_price':item['total_price'],'cart_key':f"{item['product_id']}_{item['size']}"})
